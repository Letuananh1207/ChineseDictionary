                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        IntrinsicHeight(
                          child: Row(
                            children: [
                              Icon(Icons.key, color: Colors.yellow.shade700, size: 18),
                              const SizedBox(width: 5),
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 3), // Giảm 5px trên/dưới
                                child: Container(
                                  width: 1,
                              ...
                              Expanded(
                                child: SizedBox(
                                  height: 40,
                                  child: Align(
                                    alignment: Alignment.centerLeft, // Căn giữa dọc, nhưng vẫn bên trái ngang
                                    child: Text(
                                      item.shortmeaning,
