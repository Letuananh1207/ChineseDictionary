...
class SentenceLobby extends StatefulWidget {
  const SentenceLobby({super.key});

  @override
  State<SentenceLobby> createState() => _SentenceLobbyState();
}

class _SentenceLobbyState extends State<SentenceLobby> {
